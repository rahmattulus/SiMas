...
<div class="tabel" style="background-color: white; padding: 1rem; border-radius: 10px;">
    ...
    <hr>
    <form action="{{route('surat.store')}}" method="post" id="myForm" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col">
                <div class="row mb-1 ">
                    ...
                    <div class="col-7">
                        <input type="text" class="form-control form-control-sm" id="inputEmail3" name="surat_dari">
                    </div>
                </div>
                <div class="row mb-1">
            ...
            <div class="col">
                <div class="row mb-1">
                    ...
                    <div class="col-7">
                        <input type="date" class="form-control form-control-sm" id="tanggal_diterima" name="tanggal_diterima">
                    </div>
                </div>
                <div class="row mb-1">
                    <label for="inputEmail3" class="col-sm-3 form-label">No. Agenda</label>
                    <div class="col-7">
                        <input type="text" class="form-control form-control-sm" id="inputEmail3" name="no_agenda" value="{{$default_agenda ?? ''}}">
                    </div>
                </div>
                <div class="row mb-1">
                    <label for="inputEmail3" class="col-sm-3 form-label">Sifat</label>
                    <div class="col-7">
                        <input type="text" class="form-control form-control-sm" id="inputEmail3" name="sifat">
                    </div>
                </div>
                <div class="row mb-1">
        ...
        <div class="row mt-2">
            <div class="col">
                ...
                <textarea id="" class="form-control" name="catatan"></textarea>
            </div>
